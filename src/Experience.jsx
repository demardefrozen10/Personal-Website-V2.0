...
export default function Experience() {
    ...
    <div className="max-w-3xl mx-auto px-4 pt-32">
        <h1 className="text-xl font-medium pb-3 dark:text-white">Work Experience</h1>
        <p className="pb-7 dark:text-neutral-300">This is my current work experience. I am in my 3rd year of Computer Science at York University so far!</p>
    </div>
    <div className="max-w-3xl mx-auto px-4 flex justify-center flex-col gap-11">
    <div className="relative w-full overflow-hidden rounded-xl bg-white/75 dark:bg-zinc-900/90 p-4 ring-1 ring-neutral-200 ring-offset-8 ring-offset-neutral-100 dark:ring-neutral-700 dark:ring-offset-zinc-900 md:p-6 motion-preset-blur-up-md motion-delay-0 transition-transform duration-300 hover:scale-105">
    <div className="flex justify-between items-center">
    <img src={RBCBorealis} height="50" width="60" className="pb-1"></img>
    <p className="dark:text-neutral-200">Jan 2025 - Aug 2025</p>
    </div>
    <h1 className="pb-1 dark:text-white">Data Engineer Intern</h1>
    <p className="dark:text-neutral-200">RBC Borealis • Internship</p>
    <p className="pt-1 dark:text-neutral-200">Toronto, Canada</p>
...
Platform YARN cluster to perform Spark transformations.</p>
    ...
    <p className="dark:text-neutral-200">May 2024 - Dec 2024</p>
    </div>
    <h1 className="pb-1 dark:text-white">Software Developer Intern</h1>
    <p className="dark:text-neutral-200">Dayforce, Inc. • Internship</p>
    <p className="pt-1 dark:text-neutral-200">Toronto, Canada • Remote</p>
        <div className="text-gray-500 dark:text-neutral-300">
...
merging fixes into the main branch.</p>
    ...
    <p className="dark:text-neutral-200">May 2023 - Aug 2023</p>
    </div>
    <h1 className="pb-1 dark:text-white">Surface Janitor</h1>
    <p className="dark:text-neutral-200">Toronto Transit Commission • Summer Student</p>
    <p className="pt-1 dark:text-neutral-200">Toronto, Canada</p>
        <div className="text-gray-500 dark:text-neutral-300">
    ...
    <div className="max-w-3xl mx-auto px-4 pt-10">
        <h1 className="text-xl font-medium pb-3 dark:text-white">Volunteer Experience</h1>
        <p className="pb-7 dark:text-neutral-300">Volunteer experience includes clubs and other work that does not count as professional experience.</p>
    </div>
    <div className="max-w-3xl mx-auto px-4 flex justify-center flex-col gap-11 ">
    <div className="relative w-full overflow-hidden rounded-xl bg-white/75 dark:bg-zinc-900/90 p-4 ring-1 ring-neutral-200 ring-offset-8 ring-offset-neutral-100 dark:ring-neutral-700 dark:ring-offset-zinc-900 md:p-6 motion-preset-blur-up-md motion-delay-0 transition-transform duration-300 hover:scale-105">
    <div className="flex justify-between items-center">
    <img src={GDSC} height="50" width="60" className="pb-1"></img>
    <p className="dark:text-neutral-200">Sept 2023 - May 2024</p>
    </div>
    <h1 className="pb-1 dark:text-white">Technical Lead</h1>
    <p className="dark:text-neutral-200">Google Developer Student Clubs • Club Executive</p>
        <div className="text-gray-500 dark:text-neutral-300">
    ...
    <p className="dark:text-neutral-200">Sept 2018 - Mar 2020</p>
    </div>
    <h1 className="pb-1 dark:text-white">Support Staff</h1>
    <p className="dark:text-neutral-200">Toronto District School Board • Volunteer</p>
        <div className="text-gray-500 dark:text-neutral-300">

    <p className="pt-2 ">Helped volunteer for international languages program in highschool in order to fufill highschool volunteer hours requirements.</p>
    </div>
